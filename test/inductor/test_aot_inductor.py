...
CPU_TEST_FAILURES = {
    ...
    "test_duplicate_constant_folding": fail_with_and_without_stack_allocation(is_skip=True),
...
copy_tests(
    ...
    # test_failures, xfail by default, set is_skip=True to skip
    {
        ...
        "test_duplicate_constant_folding": TestFailure(("non_abi_compatible_cpu",), is_skip=True),
